...
run_deepvariant --model_type=PACBIO --ref $Genome --reads {$SAMPLE}.mini2.remap.sort.bam --output_vcf {$SAMPLE}.deepvariants.vcf.gz --intermediate_results_dir {$SAMPLE}_intermediate_results --num_shards 128 --logging_dir {$SAMPLE}_logging
