...
srun --export=all -n 1 -c 128 singularity exec /scratch/pawsey0399/bguo1/deepvariant_latest.sif run_deepvariant --model_type PACBIO --ref /scratch/pawsey0399/bguo1/0.assembly/02.quality_assessmnet/02.remap/00.index/S1_hifi.asm.bp.p_ctg.fa --reads S1/S1_mini2_remap.sort.bam --output_vcf S1/S1.mini2.deepvariant.vcf.gz --intermediate_results_dir S1/S1_deepvariant_intermediate --num_shards 128  --logging_dir S1/S1_deepvariant_log
srun --export=all -n 1 -c 128 singularity exec /scratch/pawsey0399/bguo1/deepvariant_latest.sif run_deepvariant --model_type PACBIO --ref /scratch/pawsey0399/bguo1/0.assembly/02.quality_assessmnet/02.remap/00.index/S2_hifi.asm.bp.p_ctg.fa --reads S2/S2_mini2_remap.sort.bam --output_vcf S2/S2.mini2.deepvariant.vcf.gz --intermediate_results_dir S2/S2_deepvariant_intermediate --num_shards 128  --logging_dir S2/S2_deepvariant_log
